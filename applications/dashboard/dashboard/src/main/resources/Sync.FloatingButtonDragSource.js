 ...
 */
Echo.Sync.FloatingButtonDragSource = Core.extend(Echo.Render.ComponentSync, {
    
    $load: function() {
        Echo.Render.registerPeer("Echo.FloatingButtonDragSource", this);
    },
    ...
    _dragMoveStart: function(e) {
        ...
        // change position to closed to the cursor
        this._dragDiv.firstChild.style.top = "0px";
        this._dragDiv.firstChild.style.left = "0px";
    ...
    _dragDrop: function(e) {
        ...
        this.component.doDrop(dropTarget.renderId, specificTarget.renderId, e.clientX, e.clientY);
    },
