 ...
 */
/**
 * Component rendering peer: ContentPaneWithFloatScroll.
 ...
 */
Echo.Sync.ContentPaneWithFloatScroll = Core.extend(Echo.Render.ComponentSync, {

    $load: function() {
        Echo.Render.registerPeer("ContentPaneWithFloatScroll", this);
    },
    ...
    renderDisplay: function() {
        ...
        if (this._pendingScrollX || this._pendingScrollY) {
            ...
            for (var i = 0; i < componentCount; ++i) {
                ...
                if (true)  { //TODO CHANGED from ORGINAL if (!child.floatingPane) {
        ...
        if (update.hasUpdatedProperties() || update.hasUpdatedLayoutDataChildren()) {
            ...
            if (addedChildren) {
                ...
                for (i = 0; i < addedChildren.length; ++i) {
                    if (false)  { //TODO (!addedChildren[i].floatingPane)
