 ...
 */
package fr.liglab.adele.m2mappbuilder.device.manager.impl.app;
...
public class ApplicationImpl extends EntityImpl implements Application, ServiceTrackerCustomizer {
	...
	private Set<Bundle> _bundles = new ConcurrentSkipListSet<Bundle>();

	public ApplicationImpl(String id, String vendor, ApplicationCategory category, BundleContext context) {
		this(id, vendor, category, ApplicationState.STOPED, context);
	}

	public ApplicationImpl(String id, String vendor,
			ApplicationCategory category, ApplicationState state, BundleContext context) {
		super(id);
		_context = context;
