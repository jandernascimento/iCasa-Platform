...
public class DeviceFaultStateVariable implements UPnPStateVariable {

	final private String NAME = "Device Fault";
	final private String DEFAULT_VALUE = "No";
	// private UPnPEventNotifier notifier;
	//private Boolean presence = Boolean.FALSE;
	private String state = "No";

	public DeviceFaultStateVariable() {
	}
