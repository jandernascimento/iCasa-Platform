 ...
 */
package fr.liglab.adele.m2mappbuilder.upnp.settopbox.importer;
 ...
 *
 */
public class UPnPSetTopBoxRoseDiscoveryImpl implements ServiceTrackerCustomizer {
		
	public static final String SETTOPBOX_UPNP_DEVICE_TYPE = "urn:schemas-upnp-org:device:ManageableDevice:1";
   ...
   private RoseMachine roseMachine;
	...
	public UPnPSetTopBoxRoseDiscoveryImpl(BundleContext context) {
