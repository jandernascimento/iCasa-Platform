 ...
 * 
 */
package fr.liglab.adele.icasa.rfid.reader.impl;
...
public class RFIDDeviceReaderImpl extends AbstractDevice implements RFIDDeviceReader, PresenceSensor, GenericDevice {
