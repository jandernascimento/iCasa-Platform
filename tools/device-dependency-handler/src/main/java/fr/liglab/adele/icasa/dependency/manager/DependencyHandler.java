...
import fr.liglab.adele.icasa.dependency.manager.util.DependencyStateListener;
...
//        }
    ...
    public void configureOld(Element componentMetadata, Dictionary configuration) throws ConfigurationException {
   	 
   	 Element[] deps = componentMetadata.getElements("requiresdevice", "fr.liglab.adele.icasa.dependency.handler.annotations");
   	 
   	 System.out.println("Elements ----> " + deps);
    ...
    public void configure(Element componentMetadata, Dictionary configuration) throws ConfigurationException {
        ...
        for (int i = 0; deps != null && i < deps.length; i++) {
            ...
            Dependency dep = new Dependency(this, field, spec, fil, optional, aggregate, nullable, isProxy, identitity, context, policy, cmp, defaultImplem, mandatoryProps);
